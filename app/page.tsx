...
export default function Home() {
  return (
    <main className="min-h-screen pt-16 overflow-x-hidden bg-white">
      ...
      {/* 5. Before/After Slider (新增區塊：招牌大改造) */}
      <BeforeAfterSlider />

      {/* 6. Horizontal Scroll Works (新增區塊：水平滾動作品集) */}
      {/* 注意：這個元件本身高度很高，會產生自然的滾動效果 */}
