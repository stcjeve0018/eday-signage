...
export default function Home() {
  return (
    <main className="min-h-screen pt-20 overflow-x-hidden bg-neutral-950">
      ...
      {/* 1. Hero Section */}
      <section className="relative h-[85vh] flex flex-col justify-center px-6 md:px-20 border-b border-neutral-900">
        <div className="max-w-7xl mx-auto w-full z-10">
          <h1 className="text-6xl md:text-9xl font-black uppercase italic tracking-tighter leading-[0.9] mb-8">
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-neutral-500 to-neutral-200 hover:text-white transition-colors duration-500">We Make</span>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-5xl md:text-8xl font-black uppercase text-white mb-8 tracking-tighter leading-none">
              WHO <br/>
              {/* 修正：原本是 blue gradient，改回 red gradient */}
